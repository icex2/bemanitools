...
typedef NvAPI_Status (*NvAPI_SYS_GetDriverAndBranchVersion_t)(
    NvU32 *, NvAPI_ShortString);
typedef NvAPI_Status (*NvAPI_GetErrorMessage_t)(
    NvAPI_Status, NvAPI_ShortString);
...
typedef NvAPI_Status (*NvAPI_DRS_FindProfileByName_t)(
    NvDRSSessionHandle, NvAPI_UnicodeString, NvDRSProfileHandle *);
typedef NvAPI_Status (*NvAPI_DRS_FindApplicationByName_t)(
    NvDRSSessionHandle,
    NvAPI_UnicodeString,
    NvDRSProfileHandle *,
    NVDRS_APPLICATION *);
typedef NvAPI_Status (*NvAPI_DRS_CreateProfile_t)(
    NvDRSSessionHandle, NVDRS_PROFILE *, NvDRSProfileHandle *);
typedef NvAPI_Status (*NvAPI_DRS_CreateApplication_t)(
    NvDRSSessionHandle, NvDRSProfileHandle, NVDRS_APPLICATION *);
typedef NvAPI_Status (*NvAPI_DRS_GetSetting_t)(
    NvDRSSessionHandle, NvDRSProfileHandle, NvU32, NVDRS_SETTING *);
typedef NvAPI_Status (*NvAPI_DRS_SetSetting_t)(
    NvDRSSessionHandle, NvDRSProfileHandle, NVDRS_SETTING *);
...
typedef NvAPI_Status (*NvAPI_GPU_GetConnectedDisplayIds_t)(
    NvPhysicalGpuHandle, NV_GPU_DISPLAYIDS *, NvU32 *, NvU32);
typedef NvAPI_Status (*NvAPI_DISP_GetTiming_t)(
    NvU32, NV_TIMING_INPUT *, NV_TIMING *);
typedef NvAPI_Status (*NvAPI_DISP_TryCustomDisplay_t)(
    NvU32 *, NvU32, NV_CUSTOM_DISPLAY *);
typedef NvAPI_Status (*NvAPI_DISP_SaveCustomDisplay_t)(
    NvU32 *, NvU32, NvU32, NvU32);
typedef NvAPI_Status (*NvAPI_DISP_RevertCustomDisplayTrial_t)(NvU32 *, NvU32);
typedef NvAPI_Status (*NvAPI_DRS_DeleteProfile_t)(
    NvDRSSessionHandle, NvDRSProfileHandle);
typedef NvAPI_Status (*NvAPI_DISP_GetDisplayConfig_t)(
    NvU32 *, NV_DISPLAYCONFIG_PATH_INFO *);
typedef NvAPI_Status (*NvAPI_DISP_SetDisplayConfig_t)(
    NvU32, NV_DISPLAYCONFIG_PATH_INFO *, NvU32);
